...
public class Utils {
    ...
    public static class ExampleUtils {
      ...
      public void setupPubsub() throws IOException {
        Options.ExamplePubsubTopicAndSubscriptionOptions pubsubOptions =
            options.as(Options.ExamplePubsubTopicAndSubscriptionOptions.class);
      ...
      public void setupBigQueryTable() throws IOException {
        Options.ExampleBigQueryTableOptions bigQueryTableOptions =
            options.as(Options.ExampleBigQueryTableOptions.class);
      ...
      public void waitToFinish(PipelineResult result) {
        ...
        if (!options.as(Options.ExampleOptions.class).getKeepJobsRunning()) {
